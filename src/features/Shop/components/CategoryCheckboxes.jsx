...
export default function CategoryCheckboxes({ categoryName, id, onChange }) {
  const handleCheckboxChange = (event) => {
    onChange(categoryName, event.target.checked);
  };
  return (
    <>
      ...
      <div className="relative flex flex-wrap items-center">
        ...
        />
        <label
          className="cursor-pointer pl-2 text-slate-500 peer-disabled:cursor-not-allowed "
          htmlFor={id}
        >
          {categoryName}
        </label>
